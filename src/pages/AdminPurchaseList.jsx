import {Table, Collapse, Typography, message, Button, Input, DatePicker, Row, Col, Card, Space} from 'antd';
    ...
    const handleSearch = () => {
        const payload = {
            ...
            date_range: filters.date_range
                ? [dayjs(filters.date_range[0]).format('YYYY-MM-DD'), dayjs(filters.date_range[1]).format('YYYY-MM-DD')]
                : undefined
        };
